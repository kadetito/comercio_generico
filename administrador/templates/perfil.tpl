				...
				<div class="card-body">
					<form name="edit_product" METHOD="POST" id="edit_product">			
						<div class="row">
							...
							<div class="col-md-6">
								<ul class="card-text">
								    <li><label for="cognomsclient">Apellidos</label><input required  type="text" name="cognomsclient" value="{$apellidoscliente}" class="form-control" /></li>  
								    <li><label for="emailclient">E-mail</label><input required  type="email" name="emailclient" value="{$Emailcliente}" class="form-control" /></li>  
								    <li><label for="usuaripass">Password</label><input  required type="text" name="usuaripass" value="{$Passwordcliente}" class="form-control" /></li>  
