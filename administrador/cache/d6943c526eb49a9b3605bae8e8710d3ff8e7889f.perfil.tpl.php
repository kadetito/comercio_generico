...
" class="form-control" /></li>  
								    <li><label for="dniclient">DNI/NIF</label><input required  type="text" name="dniclient" value="<?php echo $_smarty_tpl->tpl_vars['dnicliente']->value;?>
" class="form-control" /></li>  
								    <li><label for="usuarinom">Usuari</label><input required  type="text" name="usuarinom" value="<?php echo $_smarty_tpl->tpl_vars['Usuariocliente']->value;?>
" class="form-control" /></li>  
							...
							<div class="col-md-6">
								<ul class="card-text">
								    <li><label for="cognomsclient">Apellidos</label><input required  type="text" name="cognomsclient" value="<?php echo $_smarty_tpl->tpl_vars['apellidoscliente']->value;?>
" class="form-control" /></li>  
								    <li><label for="emailclient">E-mail</label><input required  type="email" name="emailclient" value="<?php echo $_smarty_tpl->tpl_vars['Emailcliente']->value;?>
" class="form-control" /></li>  
								    <li><label for="usuaripass">Password</label><input  required type="text" name="usuaripass" value="<?php echo $_smarty_tpl->tpl_vars['Passwordcliente']->value;?>
" class="form-control" /></li>  
