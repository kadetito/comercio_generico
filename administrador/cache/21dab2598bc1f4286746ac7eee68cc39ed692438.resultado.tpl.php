...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d1e5cdc6820a8_19226231',
...
function content_5d1e5cdc6820a8_19226231 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="container fghj">
    <div>
        ...
        <?php echo $_smarty_tpl->tpl_vars['errorLocalizado']->value;?>
   ...
   <div class="row">
		<div class="col-md-4">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['idtienda']->value;?>
</p>
				</div>
			</div>
		</div>
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['tiendanombre']->value;?>
</p>
				</div>
			</div>
		</div>
    ...
    <div class="row">
		<div class="col-md-6">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['nombretipotienda']->value;?>
</p>
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['Fechaalta']->value;?>
</p>
				</div>
			</div>
		</div>
    ...
    <div class="row">
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['nombrecliente']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['apellidoscliente']->value;?>
		...
		<div class="col-md-4">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['dnicliente']->value;?>
</p>
				</div>
			</div>
		</div>
    ...
    <div class="row">
		<div class="col-md-6">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['Emailcliente']->value;?>
</p>
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['Dominio']->value;?>
</p>
				</div>
			</div>
		</div>
    ...
    <div class="row">
		<div class="col-md-6">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['Usuariocliente']->value;?>
</p>
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['Passwordcliente']->value;?>
</p>
				</div>
			</div>
		</div>
     ...
     <div class="row">
		<div class="col-md-3">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['Friendly']->value;?>
</p>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['Protocolopreferente']->value;?>
</p>
				</div>
			</div>
		</div>
		...
		<div class="col-md-3">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['Rutaservidor']->value;?>
</p>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['Usowww']->value;?>
</p>
				</div>
			</div>
		</div>
      ...
      <div class="row">
		<div class="col-md-6">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['Nombreestructura']->value;?>
</p>
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="card">
				...
				<div class="card-body">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['Nombreestil']->value;?>
</p>
				</div>
			</div>
		</div>
       ...
       <div class="row">
		<div class="col-md-4">
			<div class="card">
				...
				<div class="card-body minj">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['bucleIdiomas']->value;?>
</p>
				</div>
			</div>
		</div>
		<div class="col-md-4">
			<div class="card">
				...
				<div class="card-body minj">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['buclePagos']->value;?>
</p>
				</div>
			</div>
		</div>
		<div class="col-md-4">
			<div class="card">
				...
				<div class="card-body minj">
					<p class="card-text"><?php echo $_smarty_tpl->tpl_vars['bucleModalidades']->value;?>
</p>
				</div>
			</div>
		</div>
...
$(document).ready(function(){
	...
	$("#cancelar").click(function() { 
		  ...
		  if ( foo == "bar" ) {
		    ...
		    if (isGood) {
		    	var id_tien="<?php echo $_smarty_tpl->tpl_vars['idtienda']->value;?>
";	
		...
		$("#confirmar").click(function() { 
			  ...
			  if ( foot == "bart" ) {
			    ...
			    if (isGoodt) {
			    	var id_tien="<?php echo $_smarty_tpl->tpl_vars['idtienda']->value;?>
";	
			    	var dni="<?php echo $_smarty_tpl->tpl_vars['dnicliente']->value;?>
";	
