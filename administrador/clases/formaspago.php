...
/**
 * Clase que gestiona las formas de pago de la tienda
 * @author kadet
 *
 */
...
class Formaspago {
    ...
    const TABLA = 'definicion_tipospago'; //constante del nombre de la tabla
    ...
    public function setNombre(){
        $this->nombre_tipago = $nombre_tipago;
    }
    
    
    //constructor
    public function __construct($nombre_tipago,$id_tipago=null)
    {
        $this->id_tipago = $id_tipago;
        $this->nombre_tipago = $nombre_tipago;
