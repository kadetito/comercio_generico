...
/**
 * Clase que gestiona los settings de estrcutura de la tienda
 * @author kadet
 *        
 */
...
class SettingsEstructuraGenerica {
    ...
    //constructor
    public function __construct($nombre_estructura,$id_tienda,$id_estruc=null)
    {      
        $this->nombre_estructura    =  $nombre_estructura;
        $this->id_tienda            =  $id_tienda;
        $this->id_estruc            =  $id_estruc;    
    ...
    public function inserSettingsEstructuraTienda(){
        ...
        $conexion = new Conexion();
        $conexion->exec("SET NAMES 'utf8'");
        $consulta = $conexion->prepare('INSERT INTO '.self::TABLA.' (nombre_estructura,id_tienda) VALUES (:nombre_estructura,:id_tienda)');      

        $consulta->bindParam(':nombre_estructura',$this->nombre_estructura);
